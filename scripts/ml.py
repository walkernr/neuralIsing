...
if __name__ == '__main__':
    ...
    CLC = SpectralClustering(n_jobs=THREADS, n_clusters=NC, random_state=SEED) # KMeans(n_jobs=THREADS, n_clusters=NPH, init='k-means++').fit_predict(MCLCTN) # AgglomerativeClustering(n_clusters=NPH, linkage='ward').fit_predict(MCLCTN) #
